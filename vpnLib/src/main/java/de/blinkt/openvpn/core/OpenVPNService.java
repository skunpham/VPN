...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public static final String KEY_LAST_PACKET_RECEIVE = "lastPacketReceive";
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        nBuilder.setContentText(Html.fromHtml(msg));
    ...
    public void updateByteCount(long in, long out, long diffIn, long diffOut) {
        ...
        if (mDisplayBytecount) {
            ...
            String netstat = "";
            try {
                downloadSpeed = humanReadableByteCount(diffIn / OpenVPNManagement.mBytecountInterval, true, getResources());
                uploadSpeed = humanReadableByteCount(diffOut / OpenVPNManagement.mBytecountInterval, true, getResources());
                netstat = String.format(getString(R.string.statusline_bytecount),
                        downloadSpeed,
                        uploadSpeed);
            ...
            sendMessage(duration, String.valueOf(lastPacketReceive), downloadSpeed, uploadSpeed);
        }
    ...
    //sending message to main activity
    private void sendMessage(String duration, String lastPacketReceive, String downloadSpeed, String uploadSpeed) {
        Intent intent = new Intent(KEY_CONNECTION_STATE);
        intent.putExtra(KEY_DURATION, duration);
        intent.putExtra(KEY_LAST_PACKET_RECEIVE, lastPacketReceive);
